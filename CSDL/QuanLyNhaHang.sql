...
(
	...
	TenMH NVARCHAR(50),
	MaLoaiMH INT,
	SoLuongTon DECIMAL(18,0) NOT NULL DEFAULT 0,
...
(
	MaMon INT,
	MaMH INT,
	QuyDoi DECIMAL(18,0) NOT NULL,
	CONSTRAINT PK_DinhLuong PRIMARY KEY(MaMon,MaMH),
	CONSTRAINT PK_DinhLuong_Mon FOREIGN KEY(MaMon) REFERENCES Mon(MaMon),
	CONSTRAINT PK_DinhLuong_MatHang FOREIGN KEY(MaMH) REFERENCES MatHang(MaMH)
)
--Table bổ sung
